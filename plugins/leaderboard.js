...
module.exports = async (client) => {
  ...
  pool.query('SELECT * FROM members ORDER BY id ASC LIMIT 20', [], (err, members) => {
    if (err) throw err
    members.rows.forEach((m, i) => {
      let dat = new Date(m.created).toLocaleString('LT', { timeZone: 'Europe/Paris', year: 'numeric', month: '2-digit', day: '2-digit' })
      if (i === 0) tC += `1️⃣ [1;2m[1;31m${dat}[0m [1;37m<<< [0m[1;31m${m.name}[0m [1;37m>>>[0m\n`
      if (i === 1) tC += `2️⃣ [1;34m${dat}[0m [1;37m<<[0m [1;34m${m.name}[0m [1;37m>>[0m\n`
      if (i === 2) tC += `3️⃣ [1;35m${dat}[0m [1;37m<[0m [1;35m${m.name}[0m [1;37m>[0m\n`
      if (i === 3) tC += `4️⃣ [1;33m${dat}[0m [1;37m[[0m [1;33m${m.name}[0m [1;37m][0m\n`
      if (i === 4) tC += `5️⃣ [1;33m${dat}[0m [1;37m[[0m [1;33m${m.name}[0m [1;37m][0m\n`
      if (i === 5) tC += `6️⃣ [1;32m${dat}[0m [1;37m[[0m [1;32m${m.name}[0m [1;37m][0m\n`
      if (i === 6) tC += `7️⃣ [1;32m${dat}[0m [1;37m[[0m [1;32m${m.name}[0m [1;37m][0m\n`
      if (i === 7) tC += `8️⃣ [1;32m${dat}[0m [1;37m[[0m [1;32m${m.name}[0m [1;37m][0m\n`
      if (i === 8) tC += `9️⃣ [1;32m${dat}[0m [1;37m[[0m [1;32m${m.name}[0m [1;37m][0m\n`
      if (i === 9) tC += `🔟 [1;32m${dat}[0m [1;37m[[0m [1;32m${m.name}[0m [1;37m][0m\n[1;37m---[0m\n`
      if (i > 9 && i < 20) tC += `#️⃣ [1;36m${dat}[0m ${m.name}\n`
    })
  })
