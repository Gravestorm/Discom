...
if (nconf.get('CHANNEL_LOG') && nconf.get('SERVER')) {
  ...
  client.on('messageUpdate', (oldMessage, newMessage) => {
    if (newMessage.author.bot || newMessage.guildId !== nconf.get('SERVER') || ['ads', 'almanax', 'annonces', 'announcements', 'bot', 'madhouse', 'rules-info', 'regles-info', 'rules-mirror', 'regles-mirror', 'leaderboard'].includes(newMessage.channel.name) || !newMessage.guild.channels.fetch(nconf.get('CHANNEL_LOG'))) return
