...
module.exports = {
  ...
  .addNumberOption(option => option.setName('num').setDescription('Enter the amount of time in minutes')),
  async execute(interaction) {
    ...
    interaction.options.getNumber('num') ? await delay(interaction.options.getNumber('num')) : await delay(120000)
